...
func ID(id uint) predicate.Level {
...
func IDEQ(id uint) predicate.Level {
	return predicate.Level(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldID), id))
	})
}
...
func IDNEQ(id uint) predicate.Level {
	return predicate.Level(func(s *sql.Selector) {
...
func IDIn(ids ...uint) predicate.Level {
	return predicate.Level(func(s *sql.Selector) {
...
func IDNotIn(ids ...uint) predicate.Level {
	return predicate.Level(func(s *sql.Selector) {
		// if not arguments were provided, append the FALSE constants,
		// since we can't apply "IN ()". This will make this predicate falsy.
		if len(ids) == 0 {
...
func IDGT(id uint) predicate.Level {
	return predicate.Level(func(s *sql.Selector) {
...
func IDGTE(id uint) predicate.Level {
	return predicate.Level(func(s *sql.Selector) {
...
func IDLT(id uint) predicate.Level {
	return predicate.Level(func(s *sql.Selector) {
...
func IDLTE(id uint) predicate.Level {
	return predicate.Level(func(s *sql.Selector) {
